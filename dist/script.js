...
/* harmony import */ var _modules_showDifference__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showDifference */ "./src/js/modules/showDifference.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.play__circle', '.overlay');
  player.init();
  var officerold = new _modules_showDifference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold .plus', '.officerold .officer__card-item');
  officerold.render();
  var officernew = new _modules_showDifference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew .plus', '.officernew .officer__card-item');
  officernew.render();
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            ...
            var path = item.parentElement.getAttribute('data-url');
...
/***/ "./src/js/modules/showDifference.js":
/*!******************************************!*\
  !*** ./src/js/modules/showDifference.js ***!
  \******************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function ShowDifference(trigger, cardsSelector) {
  ...
  _createClass(ShowDifference, [{
    ...
    value: function hideCards() {
      this.cards.forEach(function (item, index, arr) {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      ...
      this.sliders = Array.from(this.container.children).filter(function (element) {
    ...
    value: function bindTrigger() {
      ...
      this.prev.addEventListener('click', function () {
        _this2.sliders = Array.from(_this2.container.children).filter(function (element) {
          if (element.nodeName === "BUTTON") {
            return;
          }
        ...
        _this2.container.prepend(_this2.sliders[_this2.sliders.length - 1]);

        _this2.container.children[0].classList.add(_this2.active);

        _this2.container.children[0].classList.add('animated', 'fadeIn');
